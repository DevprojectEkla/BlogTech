...
from crypto._02_File import File
...
class Key(File):
    ...
    def checkKeyExtraction(self):
        '''Ajoute un message d'avertissement en fonction du résultat de l'opération checkFernet.
         NB: on veut pas forcément voir se message apparaître à chaque invocation de checkFernet()'''
        if self.checkFernet():  # on vérifie que le fichier contient une clé utilisable par Fernet
