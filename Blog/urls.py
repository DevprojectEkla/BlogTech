...
from crypto.views import cryptMsg, CryptoViewOk, CryptoViewFail
...
urlpatterns = [
    ...
    path('crypto/', CryptoViewOk.as_view(), name='crypt_ok'),
    path('crypto/', CryptoViewFail.as_view(), name='crypt_fail')
